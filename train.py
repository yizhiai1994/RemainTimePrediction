...
def train(data_address,data_name,vector_address=None, vocab_address=None, embd_dimension =2, train_splitThreshold=0.7,
          time_unit='second', batch_size=20, start_pos=3, stop_pos=30, length_size=3, prefix_minLength=0, prefix_maxLength=None,
          loss_type= 'L1Loss', optim_type= 'Adam', model_type='BiGRUAtt', hidden_dim=5,
          train_type='single', n_layer=1, dropout=1, max_epoch_num=500, learn_rate_min = 0.0001,
